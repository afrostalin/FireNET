...
#include "Movement/DummyPlayerMovement.h"
#include "Input/DummyPlayerInput.h"
#include "Animations/DummyPlayerAnimations.h"
...
class CNetPlayerRegistrator : public IEntityRegistrator , public CNetPlayer::SExternalCVars
{
	...
	{
		CFireNetServerPlugin::RegisterEntityWithDefaultComponent<CNetPlayer>("DummyPlayer", "Characters", "character.bmp", true);

		CFireNetServerPlugin::RegisterEntityComponent<CNetPlayerMovement>("DummyPlayerMovement");
		CFireNetServerPlugin::RegisterEntityComponent<CNetPlayerInput>("DummyPlayerInput");
		CFireNetServerPlugin::RegisterEntityComponent<CNetPlayerAnimations>("DummyPlayerAnimations");
